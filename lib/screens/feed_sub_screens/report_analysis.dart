                      ...
                      child: Card(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              if (report.photosList != null &&
                                  report.photosList!.isNotEmpty)
                                SizedBox(
                                  height: 150,
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(8),
                                    child: Image.network(report.photosList![0]!,
                                        ...
                                        errorBuilder:
                                            (context, error, stackTrace) =>
                                                Image.asset(
                                                  "assets/maps/something_went_wrong.png",
                                                  width: double.infinity,
                                                  height: 150,
                                                )),
                                  ),
                      ...
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => MapScreen(
                                  accidentCoordinates: LatLng(
                                      16.566222371638474, 81.5225554105058),
                                )));
                      },
                    );
                  },
